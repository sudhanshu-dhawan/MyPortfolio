...
<div className='pb-20 pt-36'>
        ...
        <div className='lg:absolute lg:left-[900px] top-24 z-50 sm:relative lg:ml-0 lg:mt-0 sm:ml-[150px] sm:mt-[100px] ' >
  ...
  <div className='flex items-center sm:justify-start justify-center sm:ml-10 lg:ml-[90px] w-full'>
    <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[80vh] flex flex-col justify-center'>
      
      <TextGenerateEffect className='font-serif' words='Hey There!' />

      <TextGenerateEffect className='font-extrabold font-serif text-4xl' words='I Am SUDHANSHU DHAWAN' />
